export default class TimerDisplay {
  ...
  getComponentelement(){
    ...
    root.append(currentTimeDisplay, startButton, pauseButton, resetButton)
...
const timer = new TimerDisplay(10);
console.log(timer.getComponentelement());
document.body.append(timer.getComponentelement());
